...
Разработать серверную часть системы учёта кадров с использованием любой СУБД (CRUD операции, jdbc). База данных должна
содержать не менее 5 таблиц. Чтение и запись данных может осуществляться параллельно. Осуществить логирование. Контроль
качества кода: модульные тесты. Сборка приложения с использованием утилит maven или gradle. Требуется провести статический
анализ кода.
